...
export const teachersField =
  "rounded-none border border-[#1a4d42]/10 bg-[#f8fbfa] px-3 py-2.5 dark:border-white/10 dark:bg-[#071411]";

export const teachersFieldLabel =
  "flex items-center gap-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-[#1a4d42]/45";

export const teachersActionButton =

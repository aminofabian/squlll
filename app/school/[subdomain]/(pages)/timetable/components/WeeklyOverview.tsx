  ...
  return (
    <div className="bg-white rounded-none shadow-lg p-6 border border-gray-200">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between p-3 bg-gradient-to-r from-primary/10 to-primary/5 rounded-none">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="p-3 bg-emerald-50 rounded-none border border-emerald-200">
          ...
          <div className="p-3 bg-amber-50 rounded-none border border-amber-200">
            <div className="flex items-center gap-2 mb-1">
          ...
          <div className="p-3 bg-sky-50 rounded-none border border-sky-200">
            <div className="flex items-center gap-2 mb-1">
          ...
          <div className="p-3 bg-orange-50 rounded-none border border-orange-200">
            <div className="flex items-center gap-2 mb-1">
          ...
          <div className="p-3 bg-purple-50 rounded-none border border-purple-200 col-span-2">
            <div className="flex items-center gap-2 mb-1">

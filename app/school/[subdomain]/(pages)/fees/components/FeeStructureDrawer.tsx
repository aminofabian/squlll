        ...
        <div className="px-6 py-4 bg-gray-50 border-b">
          <div className="flex items-center gap-4 text-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-700">Select Grades</span>
            </div>
            <div className="w-8 h-px bg-gray-300"></div>
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center text-xs font-medium">3</div>
              ...
              <div className="bg-white max-w-4xl mx-auto shadow-lg" style={{ fontFamily: 'Times New Roman, serif' }}>
                ...
                <div className="mb-6 px-6">
                  <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-4 rounded-lg border border-blue-200">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <Label className="text-sm font-medium text-blue-700">Smart Grade Assignment</Label>
                      <Button
                        variant="ghost"
                        size="sm"
                        className="ml-auto text-xs text-purple-600 hover:bg-purple-100"
                        onClick={() => {
                      ...
                      {availableGrades.map((grade) => (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <span className="text-xs font-medium">{grade.name}{grade.section}</span>
                          </div>
                        </label>
                      ))}
                    </div>
                    {selectedGrades.length > 0 && (
                      <div className="mt-3 p-2 bg-white rounded border border-blue-200">
                        <div className="text-xs text-blue-600 mb-1">Selected ({selectedGrades.length} grades):</div>
                        <div className="flex flex-wrap gap-1">
                          {selectedGrades.map(gradeId => {
                            const grade = availableGrades.find(g => g.id === gradeId)
                            return (
                              <Badge key={gradeId} variant="default" className="bg-blue-500 text-white text-xs">
                                {grade?.name}{grade?.section}
                                <X 
                                  className="h-3 w-3 ml-1 cursor-pointer hover:bg-blue-600 rounded-full" 
                                  onClick={(e) => {
                                    e.preventDefault()
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex gap-2">
                      <Button
                        variant="outline"
                        size="sm"
                        className="text-xs bg-gradient-to-r from-green-500 to-green-600 text-white border-green-500 hover:from-green-600 hover:to-green-700 shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105"
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        className="text-xs bg-gradient-to-r from-red-500 to-red-600 text-white border-red-500 hover:from-red-600 hover:to-red-700 shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105"
                        onClick={() => {
                              ...
                              {templates.map((template, index) => {
                                ...
                                return (
                                  <Button
                                    ...
                                    variant="ghost"
                                    size="sm"
                                    className="w-full justify-start text-xs h-8 hover:bg-white hover:shadow-sm"
                                    onClick={() => {
                  ...
                  <table className="w-full border-collapse border border-black shadow-lg">
                    <thead>
                      <tr className="bg-gradient-to-r from-gray-100 to-gray-200">
                        <th className="border border-black p-3 text-left font-bold">TERM</th>
                        <th className="border border-black p-3 text-left font-bold">VOTE HEAD</th>
                        <th className="border border-black p-3 text-right font-bold">AMOUNT</th>
                        <th className="border border-black p-3 w-20 text-center font-bold">ACTIONS</th>
                      </tr>
                    </thead>
                    <tbody>
                      {formData.termStructures.map((term, termIndex) => {
                        ...
                        return termComponents.map((component, componentIndex) => {
                          ...
                          return (
                            <tr key={`${termIndex}-${bucketIndex}-${actualComponentIndex}`} className="hover:bg-gradient-to-r hover:from-yellow-50 hover:to-blue-50 group transition-all duration-200">
                                  ...
                                  <div className="flex items-center justify-center">
                                    <Badge 
                                      ...
                                      className={`text-xs font-bold shadow-sm ${
                                        term.term === 'Term 1' ? 'bg-gradient-to-r from-blue-50 to-blue-100 text-blue-700 border-blue-300' :
                                        term.term === 'Term 2' ? 'bg-gradient-to-r from-green-50 to-green-100 text-green-700 border-green-300' :
                                        term.term === 'Term 3' ? 'bg-gradient-to-r from-orange-50 to-orange-100 text-orange-700 border-orange-300' :
                              ...
                              <td className="border border-black p-3">
                                <div className="relative">
                                  <input
                                    className="w-full bg-transparent border-0 focus:bg-gradient-to-r focus:from-white focus:to-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-300 rounded-lg px-2 py-1 transition-all duration-200"
                                  ...
                                  {currentEditingField === `${termIndex}-${bucketIndex}-${actualComponentIndex}-name` && (
                                    <div className="absolute top-full left-0 mt-1 text-xs text-blue-600 bg-blue-50 px-2 py-1 rounded shadow-sm">
                              ...
                              <td className="border border-black p-3 text-right">
                                <div className="relative">
                                  <input
                                    type="number"
                                    className="w-full bg-transparent border-0 text-right focus:bg-gradient-to-l focus:from-white focus:to-green-50 focus:outline-none focus:ring-2 focus:ring-green-300 rounded-lg px-2 py-1 font-mono transition-all duration-200"
                                  ...
                                  {currentEditingField === `${termIndex}-${bucketIndex}-${actualComponentIndex}-amount` && (
                                    <div className="absolute top-full right-0 mt-1 text-xs text-green-600 bg-green-50 px-2 py-1 rounded shadow-sm">
                              ...
                              <td className="border border-black p-2 text-center">
                                <div className="flex items-center justify-center gap-1">
                                  <Button
                                    variant="ghost"
                                    size="sm"
                                    className="h-7 w-7 p-0 opacity-0 group-hover:opacity-100 transition-all duration-200 hover:bg-red-100 hover:scale-110"
                                  ...
                                  <Button
                                    variant="ghost"
                                    size="sm"
                                    className="h-7 w-7 p-0 opacity-0 group-hover:opacity-100 transition-all duration-200 hover:bg-blue-100 hover:scale-110"
                                    onClick={() => {
                      ...
                      <tr className="bg-gradient-to-r from-blue-50 to-purple-50 hover:from-blue-100 hover:to-purple-100 transition-all duration-300">
                        <td className="border border-black p-3 text-center">
                          <select 
                            className="text-xs bg-white border-2 border-blue-300 rounded-lg px-3 py-2 shadow-sm hover:shadow-md transition-all duration-200 focus:ring-2 focus:ring-blue-400"
                            onChange={(e) => {
                        ...
                        <td className="border border-black p-3">
                          <div className="flex gap-2 items-center">
                            <Button
                              variant="outline"
                              size="sm"
                              className="text-xs bg-gradient-to-r from-blue-500 to-blue-600 text-white border-blue-500 hover:from-blue-600 hover:to-blue-700 shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105"
                              onClick={() => {
                            ...
                            <Button
                              variant="outline"
                              size="sm"
                              className="text-xs bg-gradient-to-r from-purple-500 to-purple-600 text-white border-purple-500 hover:from-purple-600 hover:to-purple-700 shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105"
                              onClick={() => {
                ...
                <div className="mb-8 px-6">
                  ...
                  <div className="flex justify-center">
                    <table className="border-collapse border border-black">
                      ...
                      <tbody>
                        {formData.termStructures.map((term, index) => (
                          <tr key={index} className="hover:bg-yellow-50 group">
                            <td className="border border-black p-2">
                              <select
                                className="bg-transparent border-0 focus:bg-white focus:outline-none focus:ring-1 focus:ring-blue-300 rounded px-1 font-bold"
                                value={term.term}
                ...
                <div className="mb-8 px-6">
                  ...
                  <div className="space-y-4">
                    <div className="bg-gray-50 p-4 rounded">
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <input
                            className="w-full bg-transparent border-0 border-b border-gray-300 focus:bg-white focus:outline-none focus:ring-1 focus:ring-blue-300 rounded px-1"
                    ...
                    <div className="bg-gray-50 p-4 rounded">
                      <h4 className="font-bold mb-2">Additional Settings:</h4>
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          <label className="block text-xs text-gray-600 mb-1">Student Type:</label>
                          <select
                            className="w-full bg-transparent border-0 border-b border-gray-300 focus:bg-white focus:outline-none focus:ring-1 focus:ring-blue-300 rounded px-1"
                        ...
                        <div>
                          <label className="block text-xs text-gray-600 mb-1">Structure Name:</label>
                          <input
                            className="w-full bg-transparent border-0 border-b border-gray-300 focus:bg-white focus:outline-none focus:ring-1 focus:ring-blue-300 rounded px-1"
                            value={formData.name}
                ...
                <div className="mb-8 px-6">
                  <div className="flex justify-between items-end">
                    <div>
                      ...
                      <p className="text-sm">
                        <input
                          className="bg-transparent border-0 focus:bg-yellow-50 focus:outline-none focus:ring-1 focus:ring-blue-300 rounded px-1"
                    ...
                    <div className="text-right">
                      <div className="w-24 h-24 border border-gray-300 flex items-center justify-center text-xs text-gray-500 mb-2">
                        SCHOOL<br />STAMP
                      </div>
                    </div>
                  </div>
                ...
                {/* Instructions */}
                <div className="px-6 text-sm text-gray-600 bg-gray-50 p-4 rounded">
          ...
          {toasts.map((toast) => (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                {toast.type === 'info' && <div className="w-2 h-2 bg-blue-400 rounded-full animate-pulse"></div>}

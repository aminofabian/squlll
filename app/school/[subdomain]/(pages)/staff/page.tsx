  ...
  const filteredStaff = useMemo(() => {
    let filtered = staff.filter((staffMember) => {
      ...
      const matchesSearch =
        ...
        false ||
        staffMember.phoneNumber?.includes(searchTerm) ||
        false ||
      ...
      const matchesDepartment =
        !departmentFilter || staffMember.department === departmentFilter;

      // Status filter
      const matchesStatus =
        !statusFilter || staffMember.status === statusFilter;
        ...
        <div className="max-w-md rounded-lg border border-red-200 bg-red-50 p-6 text-center">
          ...
          <div className="text-sm text-gray-600 mb-4">
            ...
            <ul className="list-disc list-inside mt-1 text-left">
              ...
              <li>
                Try direct API access (bypasses some client-side restrictions)
              </li>
            </ul>
          </div>
          <div className="flex flex-wrap gap-2 justify-center">
            ...
            <Button
              onClick={async () => {
                ...
                if (!success) {
                  toast.error(
                    "Direct API access also failed. Please check the browser console for details.",
                  );
                }
              }}
              variant="outline"
          ...
          {selectedStaff && (
            <div className="w-1/3 flex-shrink-0 overflow-auto border rounded-lg bg-white p-4">
              ...
              <div className="flex justify-end gap-2 mt-4">
                ...
                <Button variant="default">Edit Staff</Button>
              </div>
            </div>
          )}
        </div>

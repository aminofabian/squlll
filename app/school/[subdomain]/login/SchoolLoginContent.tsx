          ...
          <Card className="w-full border-4 border-primary shadow-2xl bg-white">
            ...
            <CardContent className="space-y-6 p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                {registeredBanner && (
                  <div className="p-4 text-sm text-green-800 bg-green-50 border-4 border-green-200 rounded-xl">
                    <div className="flex items-start gap-2 font-semibold">
                      <CheckCircle2 className="w-5 h-5 shrink-0 mt-0.5" />
                      <span>
                        Your school account is ready. Sign in with the email and password you just created — we&apos;ll take you to school setup next.
                      </span>
                    </div>
                  </div>
                )}

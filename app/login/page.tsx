    ...
    <div className="flex items-center justify-center mb-8">
      <div className="relative">
        <div className="w-16 h-16 bg-gradient-to-b from-slate-800 to-slate-900 border-2 border-slate-600 flex items-center justify-center shadow-2xl">
          <div className="text-white font-mono font-bold text-xl tracking-wider">
            GA
          </div>
        </div>
        ...
        <div className="text-center mb-12">
          ...
          <div className="space-y-4">
            ...
            <h1 className="text-3xl font-mono font-bold tracking-wide uppercase">
              ...
              <span className="text-slate-600 dark:text-slate-400 block text-lg mt-2">
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-3">
                <Label
                  htmlFor="email"
                  className="text-sm font-mono font-medium text-slate-700 dark:text-slate-300 uppercase tracking-wide"
                >
                  Administrator Email
                </Label>
                <Input
              ...
              <div className="flex items-center justify-between pt-2">
                <div className="flex items-center space-x-2">
                  ...
                  <Label
                    htmlFor="remember"
                    className="text-xs font-mono text-slate-600 dark:text-slate-400 uppercase tracking-wide"
                  >
                    Remember Session
                  </Label>
                </div>
              ...
              <div className="border-t-2 border-slate-200 dark:border-slate-700 pt-6">
                <div className="text-center space-y-3">
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                    This system is monitored. Unauthorized access attempts will
                    be logged and investigated. All activities are tracked for
